...
int main(int argc, char** argv) {
    ...
    RLZLPParser<Symbol, SAType> parser(data.ref, data.sa, args.p);

    std::cerr << "LP hash parser created\n";
    std::cerr << "Table slots: " << parser.cache_info().table_slots << "\n";
    std::cerr.flush();
